const categories = [
  ...
  const CategoryCard = ({ name, products, image }) => (
    <div className="flex flex-col items-center bg-white rounded-lg border border-gray-100 p-4 m-2 w-38 hover:border-green-500 hover:border-2 ">
  ...
  const TopCategory = () => (
    <div className="max-w-6xl mx-auto py-8 mt-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 px-0 lg:px-4">
