  ...
  return (
    <div className="relative w-full h-[500px]">
      ...
      >
            ...
            <div className="absolute inset-0 flex justify-end items-center px-6 sm:px-12 lg:px-20">
              <div className="text-black text-right space-y-4">
                <Slide direction="down" triggerOnce>
                  <h2 className="text-green-400 text-lg md:text-xl uppercase tracking-wide">
                    Welcome to Shopery
                  </h2>
                </Slide>
        ...
        <SwiperSlide>
          <div className="relative w-full h-full">
            <img src={anotherImage} alt="Banner 2" className="w-full h-fit object-cover" />
            <div className="absolute inset-0 flex justify-start items-center px-6 sm:px-12 lg:px-20">
